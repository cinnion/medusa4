                            ...
                            @else
                                ...
                                <div class="row">
                                    <div class="form-group col-sm-6">
                                        {!! html()->label( 'Email', 'email' ) !!} {!! html()->email( 'email', old('email'))->id('email')->class('form-control')->placeholder('Email Address') !!}
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-sm-6">
                                        {!! html()->label( 'Password', 'password' ) !!} {!! html()->password( 'password')->id('password')->class('form-control')->placeholder('Password') !!}
                                    </div>
                                </div>
                                <div class="row">
